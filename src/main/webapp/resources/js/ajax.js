...
//function validateMsg_ccb() {
//    if ($("[name=b1_ccbp_select]").val() == "-1") {
//        layer.msg("请选择省/市！", 2, 3);
//        $("[name=b1_ccbp_select]").focus();
//        return false;
//    }
//    if ($("[name=b1_ccbc_select]").val() == "-1") {
//        layer.msg("请选择城市！", 2, 3);
//        $("[name=b1_ccbc_select]").focus();
//        return false;
//    }
//    if ($("[name=bp_ccb_username]").val() == "") {
//        layer.msg("请输入姓名！", 2, 3);
//        $("[name=bp_ccb_username]").focus();
//        return false;
//    }
//
//    if ($("[name=bp_ccb_phone]").val() == "") {
//        layer.msg("请输入手机号！", 2, 3);
//        $("[name=bp_ccb_phone]").focus();
//        return false;
//    } else if (!/^1[3|4|5|7|8]\d{9}$/.test($("[name=bp_ccb_phone]").val())) {
//        layer.msg("请输入正确的手机号！", 2, 3);
//        $("[name=bp_ccb_phone]").focus();
//        return false;
//    }
//
//    if ($("[name=bp_ccb_building]").val() == "") {
//        layer.msg("请输入楼盘名称！", 2, 3);
//        $("[name=bp_ccb_building]").focus();
//        return false;
//    }
//    if ($("[name=bp_ccb_size]").val() == "") {
//        layer.msg("请输入建筑面积！", 2, 3);
//        $("[name=bp_ccb_size]").focus();
//        return false;
//    }
//    return true;
//}
